...
<head>
    ...
    <title>Perizinan | Surat Penolakan</title>
    <style>
        * {
...
<body>
    ...
    <div class="text-justify">
        <p>Dengan surat ini, pada tanggal {{ date('d-m-Y') }} pihak manajemen apartemen <strong>tidak
                menyetujui</strong>
            pengerjaan renovasi yang telah diajukan
            pada tanggal {{ date('d-m-Y H:i', strtotime($permission->proposal_date)) }} dengan detail tertera di bawah
            ini.</p>
        ...
        <p class="mb-0">Dengan alasan sebagai berikut:</p>
        <p class="mt-0"><strong>{!! nl2br($rejectionReason) !!}</strong></p>
        <br>
        <br>
